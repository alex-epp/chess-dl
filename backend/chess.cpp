...
namespace chess {
    ...
    BitBoard BaseBoard::pieces() const {
        return this->piece_BB[static_cast<size_t>(Colour::WHITE)] |
               this->piece_BB[static_cast<size_t>(Colour::BLACK)];
    }
    BitBoard BaseBoard::pieces(Colour c) const {
        return this->piece_BB[static_cast<size_t>(c)];
    }
    BitBoard BaseBoard::pieces(Piece::Type p) const {
        return this->piece_BB[p];
    }
    BitBoard BaseBoard::pieces(Piece::Type p, Colour c) const {
        return this->piece_BB[p] & this->piece_BB[static_cast<size_t>(c)];
    }
    BitBoard BaseBoard::pawns() const {
        return this->pieces(Piece::PAWN);
    }
    BitBoard BaseBoard::pawns(Colour c) const {
        return this->pieces(Piece::PAWN, c);
    }
    BitBoard BaseBoard::knights() const {
        return this->pieces(Piece::KNIGHT);
    }
    BitBoard BaseBoard::knights(Colour c) const {
        return this->pieces(Piece::KNIGHT, c);
    }
    BitBoard BaseBoard::bishops() const {
        return this->pieces(Piece::BISHOP);
    }
    BitBoard BaseBoard::bishops(Colour c) const {
        return this->pieces(Piece::BISHOP, c);
    }
    BitBoard BaseBoard::rooks() const {
        return this->pieces(Piece::ROOK);
    }
    BitBoard BaseBoard::rooks(Colour c) const {
        return this->pieces(Piece::ROOK, c);
    }
    BitBoard BaseBoard::queens() const {
        return this->pieces(Piece::QUEEN);
    }
    BitBoard BaseBoard::queens(Colour c) const {
        return this->pieces(Piece::QUEEN, c);
    }
    BitBoard BaseBoard::kings() const {
        return this->pieces(Piece::KING);
    }
    BitBoard BaseBoard::kings(Colour c) const {
