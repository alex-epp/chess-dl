...
namespace chess {
    ...
    constexpr std::array<std::uint64_t, 781> POLYGLOT_RANDOM_NUMBERS = {
    ...
    public:
        ...
        explicit inline ZobristHasher(std::array<std::uint64_t, 781> random_numbers = POLYGLOT_RANDOM_NUMBERS) noexcept;

        [[nodiscard]] inline Hash operator () (const Board& board) const noexcept;
    private:
        [[nodiscard]] inline Hash hash_board(const Board& board) const noexcept;
        [[nodiscard]] inline Hash hash_castling(const Board& board) const noexcept;
        [[nodiscard]] inline Hash hash_ep_square(const Board& board) const noexcept;
        [[nodiscard]] inline Hash hash_turn(const Board& board) const noexcept;

        std::array<std::uint64_t, 781> random_numbers;
    };


    ZobristHasher::ZobristHasher(std::array<std::uint64_t, 781> random_numbers) noexcept
            : random_numbers(random_numbers) {}

    ZobristHasher::Hash ZobristHasher::hash_board(const chess::Board& board) const noexcept {
        Hash hash = 0;
    ...
    ZobristHasher::Hash ZobristHasher::hash_castling(const Board& board) const noexcept {
        Hash hash = 0;
    ...
    ZobristHasher::Hash ZobristHasher::hash_ep_square(const Board& board) const noexcept {
    ...
    ZobristHasher::Hash ZobristHasher::hash_turn(const Board& board) const noexcept {
        return board.get_turn() == Colour::WHITE ? this->random_numbers[780] : 0;
    }

    ZobristHasher::Hash ZobristHasher::operator()(const Board& board) const noexcept {
